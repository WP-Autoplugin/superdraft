  ...
  const withImageGeneration = createHigherOrderComponent(OriginalComponent => {
    return props => {
      ...
      const ImageGenerationControls = () => {
        ...
        return wp.element.createElement(wp.element.Fragment, {}, wp.element.createElement('div', {}, wp.element.createElement(Button, {
        ...
        }, __('Generate Image', 'superdraft')), wp.element.createElement(Button, {
          isSecondary: mode !== 'edit',
          isPrimary: mode === 'edit',
          onClick: () => toggleMode('edit'),
          disabled: !featuredImageId
        }, __('Edit Image', 'superdraft'))), mode && wp.element.createElement('div', {}, wp.element.createElement(TextareaControl, {

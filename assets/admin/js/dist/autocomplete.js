...
/* harmony export */   getRawSearchTermWithoutCaret: () => (/* binding */ getRawSearchTermWithoutCaret),
 ...
 */
function getRawSearchTermWithoutCaret(blockContent) {
...
/* harmony import */ var _blockContext__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./blockContext */ "./src/blockContext.js");
...
const fetchSuggestions = async (search, context) => {
  ...
  try {
    ...
    const suggestions = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
...
const debouncedFetchOptions = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.debounce)(async (search, context) => {
  // Don't fetch if empty search and empty_search is disabled
  if (!search && !window.superdraftSettings?.autocomplete?.empty_search) {
    return [];
  }
  const rawSearch = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getRawSearchTermWithoutCaret)(context.blockContent);
...
const aiAutocompleter = {
  ...
  options: async function (search) {
    const context = (0,_blockContext__WEBPACK_IMPORTED_MODULE_3__.getBlockContext)();
  ...
  getOptionLabel: option => {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("span", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("span", {
        className: "truncated-label",
        children: option.label
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("span", {
        className: "full-label",
        children: option.completion
      })]
    });
  },
...
function initializeAutocompleter() {
  (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)('editor.Autocomplete.completers', 'superdraft/autocompleter', addAiAutocompleter, 10);
}

...
/* harmony export */   getBlockContext: () => (/* binding */ getBlockContext)
/* harmony export */ });
/**
  ...
  if (blockEditor) {
    ...
    if (selectedBlock) {
      ...
      if (currentIndex !== -1) {
        ...
        if (currentIndex > 0) {
          const prevBlocks = leafBlocks.slice(Math.max(currentIndex - contextLength, 0), currentIndex).map(block => wp.blocks.serialize(block).replace(/<!--.*?-->/gs, ''));
          context.prevBlockContent = prevBlocks.join('\n');
        }
        if (currentIndex < leafBlocks.length - 1) {
          const nextBlocks = leafBlocks.slice(currentIndex + 1, currentIndex + 1 + contextLength).map(block => wp.blocks.serialize(block).replace(/<!--.*?-->/gs, ''));
...
/* harmony import */ var _blockContext__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./blockContext */ "./src/blockContext.js");
 ...
 */
const withSmartCompose = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.createHigherOrderComponent)(BlockEdit => {
  return props => {
    ...
    const prevContentRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useRef)(htmlContent.replace(/<[^>]+>/g, ''));
    const [suggestion, setSuggestion] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)('');
    const isTypingRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useRef)(false);
    const timeoutRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useRef)(null);
    const suggestionAbortController = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useRef)(null);
    const dismissedRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useRef)(false);
    const [shouldSetSelection, setShouldSetSelection] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
      if (shouldSetSelection) {
        ...
        (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)('core/block-editor').selectionChange(clientId, 'content',
        // Attribute key for paragraph block.
        endOffset,
        // Start offset.
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
      ...
      timeoutRef.current = setTimeout(() => {
        ...
        const context = (0,_blockContext__WEBPACK_IMPORTED_MODULE_6__.getBlockContext)();
        ...
        .then(data => {
          ...
          const updatedSuggestion = maybeConsumeNextCharacter(prevContentRef.current, plainCurrent, data.text);
    ...
    const onInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)(event => {
      ...
      if (suggestion) {
        const updatedSuggestion = maybeConsumeNextCharacter(prevContentRef.current, plainCurrent, suggestion);
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(BlockEdit, {
        ...props
      }), isSelected && suggestion && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
        style: {
          position: 'absolute',
          top: 0,
          left: 0,
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)('editor.BlockEdit', 'inline-smart-compose/with-smart-compose', withSmartCompose);
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_0__.registerPlugin)('inline-smart-compose', {
  render: () => null
});
})();
...
/******/ })()
;
//# sourceMappingURL=smartcompose.js.map